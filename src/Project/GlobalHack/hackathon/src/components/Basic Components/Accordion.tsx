...
export const Default = (props: AccordionProps): JSX.Element => {
  ...
  return (
    <Box>
      ...
      <Accordion allowMultiple allowToggle borderColor="hackathonUSA.500">
        {AccordionElementList?.length
          ? AccordionElementList.map((element, index) => (
              <AccordionItem key={index}>
                <AccordionButton
                  _expanded={{ bg: 'hackathonUSA.blue', color: 'white' }}
                  px={2}
                  py={4}
                  color="hackathonUSA.blue"
                >
                ...
                <AccordionPanel color="hackathonUSA.gray.4">
