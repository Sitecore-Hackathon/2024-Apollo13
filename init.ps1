...
Param (
    ...
    [Parameter(HelpMessage = "hackathonUSA ANZ CPD Client Key.")]
    [string]$SUCGON_ANZ_CDP_CLIENT_KEY,
    [Parameter(HelpMessage = "hackathonUSA ANZ CPD Target URL.")]
    [string]$SUCGON_ANZ_CDP_TARGET_URL,
    [Parameter(HelpMessage = "hackathonUSA ANZ CPD Point of Sale.")]
    [string]$SUCGON_ANZ_CDP_POINTOFSALE,
    [Parameter(HelpMessage = "hackathonUSA EU CPD Client Key.")]
    [string]$SUCGON_EU_CDP_CLIENT_KEY,
    [Parameter(HelpMessage = "hackathonUSA EU CPD Target URL.")]
    [string]$SUCGON_EU_CDP_TARGET_URL,
    [Parameter(HelpMessage = "hackathonUSA EU CPD Point of Sale.")]
    [string]$SUCGON_EU_CDP_POINTOFSALE,
    [Parameter(HelpMessage = "hackathonUSA INDIA CPD Client Key.")]
    [string]$SUCGON_INDIA_CDP_CLIENT_KEY,
    [Parameter(HelpMessage = "hackathonUSA INDIA CPD Target URL.")]
    [string]$SUCGON_INDIA_CDP_TARGET_URL,
    [Parameter(HelpMessage = "hackathonUSA INDIA CPD Point of Sale.")]
    [string]$SUCGON_INDIA_CDP_POINTOFSALE,
    [Parameter(HelpMessage = "hackathonUSA NA CPD Client Key.")]
    [string]$SUCGON_NA_CDP_CLIENT_KEY,
    [Parameter(HelpMessage = "hackathonUSA NA CPD Target URL.")]
    [string]$SUCGON_NA_CDP_TARGET_URL,
    [Parameter(HelpMessage = "hackathonUSA NA CPD Point of Sale.")]
    [string]$SUCGON_NA_CDP_POINTOFSALE,
    [Parameter(HelpMessage = "hackathonUSA2024 EU CPD Client Key.")]
    [string]$SUCGON2024_EU_CDP_CLIENT_KEY,
    [Parameter(HelpMessage = "hackathonUSA2024 EU CPD Target URL.")]
    [string]$SUCGON2024_EU_CDP_TARGET_URL,
    [Parameter(HelpMessage = "hackathonUSA2024 EU CPD Point of Sale.")]
...
$scjssconfig = @{
    sitecore= @{
        deploySecret = $xmCloudBuild.renderingHosts.'hackathonUSAanz'.jssDeploymentSecret
        deployUrl = "https://xmcloudcm.localhost/sitecore/api/jss/import"
      }
    }

ConvertTo-Json -InputObject $scjssconfig | Out-File -FilePath "src\project\hackathonUSA\hackathonUSAAnzSxa\scjssconfig.json"
ConvertTo-Json -InputObject $scjssconfig | Out-File -FilePath "src\project\hackathonUSA\hackathonUSAEuSxa\scjssconfig.json"
ConvertTo-Json -InputObject $scjssconfig | Out-File -FilePath "src\project\hackathonUSA\hackathonUSAIndiaSxa\scjssconfig.json"
ConvertTo-Json -InputObject $scjssconfig | Out-File -FilePath "src\project\hackathonUSA\hackathonSxa\scjssconfig.json"
...
if ($Edge_NoDocker) {
    ...
    Write-Host "Creating .env for hackathonUSA Sites"
    $hackathonUSAEnvContents = 
@"
SITECORE_API_HOST={0}
SITECORE_API_KEY={1}
GRAPH_QL_ENDPOINT={2}
...
"@ -f $envVars.EXPERIENCE_EDGE_URL, $envVars.EXPERIENCE_EDGE_TOKEN, $envVars.GRAPH_QL_ENDPOINT
    ...
    Write-Host "Writing .env files for hackathonUSA Heads"
    $hackathonUSAEnvContents | Out-File "src/Project/hackathonUSA/hackathonUSAAnzSxa/.env"
    $hackathonUSAEnvContents | Out-File "src/Project/hackathonUSA/hackathonUSAEuSxa/.env"
    $hackathonUSAEnvContents | Out-File "src/Project/hackathonUSA/hackathonUSAIndiaSxa/.env"
    $hackathonUSAEnvContents | Out-File "src/Project/hackathonUSA/hackathonSxa/.env"
    ...
    if(Test-Path './src/Project/hackathonUSA/hackathonUSAAnzSxa/.env') { Remove-Item -Path './src/Project/hackathonUSA/hackathonUSAAnzSxa/.env' -Force }
    if(Test-Path './src/Project/hackathonUSA/hackathonUSAEuSxa/.env') { Remove-Item -Path './src/Project/hackathonUSA/hackathonUSAEuSxa/.env' -Force }
    if(Test-Path './src/Project/hackathonUSA/hackathonUSAIndiaSxa/.env') { Remove-Item -Path './src/Project/hackathonUSA/hackathonUSAIndiaSxa/.env' -Force }
    if(Test-Path './src/Project/hackathonUSA/hackathonSxa/.env') { Remove-Item -Path './src/Project/hackathonUSA/hackathonSxa/.env' -Force }
}
...
$CM_Host = $Host_Suffix
$MVP_Host = "Winner.$Host_Suffix"
$hackathonUSA_EU_HOST = "hackathonUSAeu.$Host_Suffix"
$hackathonUSA_ANZ_HOST = "hackathonUSAanz.$Host_Suffix"
$hackathonUSA_INDIA_HOST = "hackathonUSAindia.$Host_Suffix"
$hackathonUSA_NA_HOST = "hackathon.$Host_Suffix"
$hackathonUSA2024_EU_HOST = "hackathonUSAeu2024.$Host_Suffix"
...
Add-HostsEntry $hackathonUSA_EU_HOST
Add-HostsEntry $hackathonUSA_ANZ_HOST
Add-HostsEntry $hackathonUSA_INDIA_HOST
Add-HostsEntry $hackathonUSA_NA_HOST
Add-HostsEntry $hackathonUSA2024_EU_HOST
